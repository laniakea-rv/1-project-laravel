...
@section("content")
    <div class="flex justify-center">
        <form class="bg-gray-300 mt-10 w-5/6 rounded shadow flex flex-col pt-5 px-5" method="POST"
            action="{{ route('muziek.update', $muziek->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <br>
            <div>
            ...
            <div>
                ...
                <input class="bg-gray-100" type="text" id="beschrijving" name="beschrijving"
                    value="{{$muziek->beschrijving}}" required>
            </div>
            <div>
            ...
            <div>
                ...
                <input class="bg-gray-100" type="number" id="prijs" name="prijs" value="{{$muziek->prijs}}" step="0.01"
                    required>
            </div>
            <div>
                ...
                @endif
                <input type="file" id="afbeelding" accept=".jpg,.jpeg,.png" name="afbeelding">
            </div>
            <br>
